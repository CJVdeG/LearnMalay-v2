...
def is_known():
    ...
    if current_card in to_learn:
        ...
        canvas.itemconfig(card_title,
                          text="Done. Load new file or clear words to learn.")
...
def restart_program():
    ...
    initialize_flashcards(
        f"data/{selected_file_var.get()}")  # Load the selected file
...
card_title = canvas.create_text(450,
                                100,
                                text="Title",
                                font=("Arial", 25, "italic"))
card_word = canvas.create_text(450,
                               200,
                               text="Word",
                               font=("Arial", 30, "bold"),
                               width=700)
...
button_wrong = Button(image=img_wrong,
                      width=100,
                      height=100,
                      command=next_card)
...
button_direction = Button(root,
                          text="Switch to English to Malay",
                          font=("Arial", 15, "bold"),
                          width=25,
...
file_dropdown.configure(font=("Arial", 14, "normal"),
                        width=25)  # Apply font and width styling
file_dropdown.place(x=900, y=250)

# Button to load the selected file
load_file_button = Button(root,
