...
root.config(pady=0, bg="#B1DDC6", width=900, height=620)

flip_timer = root.after(3000, func=flip_card)

# Card FRONT
canvas = Canvas(width=900, height=600, bg="#B1DDC6")
card_front_img = PhotoImage(file="images/card_front.png", width=800, height=600)
card_back_img = PhotoImage(file="images/card_back.png", width=800, height=600)
card_background = canvas.create_image(450, 380, image=card_front_img)
card_title = canvas.create_text(450, 200, text="Title", font=("Arial", 25, "italic"))
card_word = canvas.create_text(450, 300, text="Word", font=("Arial", 30, "bold"), width=700)
...
file_dropdown.configure(font=("Arial", 10, "normal"))  # Apply font and width styling
file_dropdown.place(x=670, y=50)
